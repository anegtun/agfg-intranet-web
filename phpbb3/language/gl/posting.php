...
$lang = array_merge($lang, array(
	...
	'BBCODE_Y_HELP'				=> 'Listaxe: Engadir elementos de listaxe',
	...
	'DELETE_POST_CONFIRM'		=> 'Estás seguro de quereres eliminar esta mensaxe?',
	'DELETE_POST_PERMANENTLY_CONFIRM'	=> 'Estás seguro de quereres eliminar <strong>permanentemente</strong> esta mensaxe?',
	'DELETE_POST_PERMANENTLY'	=> array(
		1	=> 'Eliminada permanentemente esta mensaxe, polo que xa non pode ser recuperada',
		2	=> 'Eliminadas permanentemente %1$d mensaxes, polo que xa non poden ser recuperadas',
	),
	'DELETE_POSTS_CONFIRM'		=> 'Estás seguro de quereres eliminar estas mensaxes?',
	'DELETE_POSTS_PERMANENTLY_CONFIRM'	=> 'Estás seguro de quereres eliminar <strong>permanentemente</strong> estas mensaxes?',
	...
	'DELETE_TOPIC_CONFIRM'		=> 'Estás seguro de quereres eliminar este tema?',
	...
	'DELETE_TOPIC_PERMANENTLY_CONFIRM'	=> 'Estás seguro de quereres eliminar <strong>permanentemente</strong> este tema?',
	'DELETE_TOPICS_CONFIRM'		=> 'Estás seguro de quereres eliminar estes temas?',
	'DELETE_TOPICS_PERMANENTLY_CONFIRM'	=> 'Estás seguro de quereres eliminar <strong>permanentemente</strong> estes temas?',
	'DISABLE_BBCODE'			=> 'Desactivar BBCode',
	'DISABLE_MAGIC_URL'			=> 'Non procesar URLs de xeito automático',
	'DISABLE_SMILIES'			=> 'Desactivar risoños',
	'DISALLOWED_CONTENT'		=> 'A subida foi rexeitada por mor da identificación do arquivo subido como un posíbel vector de ataque.',
	...
	'MAX_FLASH_HEIGHT_EXCEEDED'	=> array(
		1	=> 'Os teus arquivos só poden ser de %1$d píxel de alto como máximo.',
		2	=> 'Os teus arquivos só poden ser de %1$d píxeles de alto como máximo.',
	),
	'MAX_FLASH_WIDTH_EXCEEDED'	=> array(
		1	=> 'Os teus arquivos só poden ser de %1$d píxel de largo como máximo.',
		2	=> 'Os teus arquivos só poden ser de %1$d píxeles de largo como máximo.',
	),
	...
	'MAX_IMG_WIDTH_EXCEEDED'	=> array(
		1	=> 'As túas imaxes só poden ser de %1$d píxel de largo como máximo.',
		2	=> 'As túas imaxes só poden ser de %1$d píxeles de largo como máximo.',
	),
	...
	'PHP_UPLOAD_STOPPED'		=> 'A extensión PHP parou de subir o ficheiro.',
	...
	'PHP_SIZE_OVERRUN'			=> 'O tamaño do arquivo adxunto é grande de máis. O máximo tamaño permitido é de %1$d %2$s.<br />Ten en conta que isto vén estabelecido en php.ini e non pode ser anulado con outro valor.',
	...
	'QUOTE_DEPTH_EXCEEDED'		=> array(
		1	=> 'Só podes incluír %1$d cita dentro doutras.',
		2	=> 'Só podes incluír %1$d citas dentro doutras.',
	),
	...
	'SAVE_DRAFT_CONFIRM'		=> 'Ten en conta que os rascuños gardados só inclúen o asunto e a mensaxe. Calquera outro elemento será eliminado. Queres gardar agora o teu rascuño?',
	'SMILIES'					=> 'Risoños',
	...
	'TOO_MANY_URLS'				=> 'A túa mensaxe contén demasiados URLs. Está permitido un máximo de %d URLs.',
	...
	'WRONG_SIZE'				=> 'A imaxe debe ser cando menos de %1$d píxeles de largo, %2$d  píxeles de alto e como máximo de %3$d píxeles de largo por %4$d píxeles de alto. A imaxe enviada é de %5$d píxeles de anchura por %6$d píxeles de altura.',
));
