...
$lang = array_merge($lang, array(
	'ACP_BBCODES_EXPLAIN'		=> 'O BBCode é unha linguaxe semellante a HTML que ofrece un meirande control sobre que se amosa e como se amosa ese algo. Dende esta páxina poderás engadir, eliminar e editar BBCodes á medida.',
	'ADD_BBCODE'				=> 'Engadir novo BBCode',

	'BBCODE_DANGER'				=> 'O BBCode que estás tentando engadir semella empregar un símbolo {TEXT} dentro dun atributo HTML. Isto pode ser un problema de seguranza de XSS. Mellor tenta empregar os tipos {SIMPLETEXT} ou {INTTEXT}, máis restritivos. Prosegue só se comprendes os riscos xerados e consideras o uso de {TEXT} absolutamente inevitábel.',
	...
	'tokens'	=>	array(
		'TEXT'			=> 'Calquera texto, incluídos caracteres especiais, números etc. Non podes usar esta mostra en etiquetas HTML. En troques disto, tenta empregar IDENTIFIER, INTTEXT ou SIMPLETEXT.',
...
$lang = array_merge($lang, array(
	...
	'NO_SMILIES_ADD'	=> 'Non hai risoños dispoñíbeis para engadir.',
	'NO_SMILIES_EDIT'	=> 'Non hai risoños dispoñíbeis para modificar.',
...
// Disallow Usernames
$lang = array_merge($lang, array(
	'ACP_DISALLOW_EXPLAIN'	=> 'Dende aquí podes controlar os nomes de usuario que non poden ser usados. Nomes de usuario prohibidos poden levar o carácter asterisco *. Ten en conta que non se pode prohibir un nome de usuario xa activo, primeiro tense que borrar o nome e despois prohibilo.',
...
$lang = array_merge($lang, array(
	...
	'REASON_ALREADY_EXIST'		=> 'Xa existe un motivo con ese título, introduce outro título para este motivo.',
