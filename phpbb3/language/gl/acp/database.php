...
$lang = array_merge($lang, array(
	'ACP_BACKUP_EXPLAIN'	=> 'Dende aquí podes realizar copias de respaldo de todos os teus datos en relación co phpBB. Poderás gardar o arquivo resultante no teu cartafol store/ ou descargalo directamente. Dependendo da configuración do teu servidor poderás comprimilo en diversos formatos. Se queres incluír algunhas táboas "á medida" adicionais, enuméraas no campo de táboas adicional, separadas por vírgulas.',
	'ACP_RESTORE_EXPLAIN'	=> 'Isto restaurará por completo todas as táboas do phpBB a partir dun arquivo gardado. Podes <u>escoller</u> entre subir o arquivo da copia de respaldo a través deste formulario ou subilo manualmente ao servidor. Se o teu servidor o soporta, podes usar un arquivo de texto comprimido con gzip ou bzip2 que posteriormente será descomprimido de xeito automático. <b>ADVERTENCIA</b> Isto vai sobrescribir todos os datos actuais. O proceso de restauración pode levar un chisco, polo que non debes saír desta páxina até que remate. As copias de seguridade gárdanse no cartafol <samp>store/</samp> e suponse que foron xerados coa funcionalidade de copia de seguridade do phpBB. A restauración de copias de seguridade non creadas co sistema integrado poden funcionar pero tamén pode que non funcionen.',

	'BACKUP_DELETE'			=> 'O ficheiro coa copia de respaldo foi eliminado correctamente',
	'BACKUP_INVALID'		=> 'O arquivo seleccionado para copia de respaldo é inválido',
	'BACKUP_NOT_SUPPORTED'	=> 'A copia de respaldo seleccionada non está soportada',
	...
	'RESTORE_SELECTED_BACKUP'	=> 'Estás certo de quereres restaurar a copia de seguranza escollida?',
