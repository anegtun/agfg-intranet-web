...
$lang = array_merge($lang, array(
	...
	'ACP_VC_SETTINGS'					=> 'Contador e medidas de spambot',
	...
	'DIRECTORY_NOT_WRITABLE'	=> 'A ruta introducida "%s" non ten permisos para escritura',
	'DISABLE'					=> 'Desactivar',
	'DOWNLOAD'					=> 'Descargar',
	...
	'PARSE_SMILIES'						=> 'Comprobar risoños',
...
$lang = array_merge($lang, array(
	...
	'NO_PHPINFO_AVAILABLE'	=> 'No foi posíbel determinar a información relativa á configuración do teu PHP. Desactivouse o Phpinfo() por motivos de seguridade.',
));
...
$lang = array_merge($lang, array(
	...
	'ERROR_MBSTRING_ENCODING_TRANSLATION_EXPLAIN'	=> '<var>mbstring.encoding_translation</var> debe configurarse cun valor de 0. Podes verificar o valor actual na páxina de <samp>información do PHP</samp>.',
	'ERROR_MBSTRING_HTTP_INPUT'						=> 'A conversión de caracteres HTTP de entrada non está configurada ao xeito',
	'ERROR_MBSTRING_HTTP_INPUT_EXPLAIN'				=> '<var>mbstring.http_input</var> debe configurarse como <samp>pass</samp>. Podes verificar o valor actual na páxina de <samp>información do PHP</samp>.',
	'ERROR_MBSTRING_HTTP_OUTPUT'					=> 'A conversión de caracteres HTTP de saída non está configurada ao xeito',
	'ERROR_MBSTRING_HTTP_OUTPUT_EXPLAIN'			=> '<var>mbstring.http_output</var> debe configurarse como <samp>pass</samp>. Podes verificar o valor actual na páxina de <samp>información do PHP</samp>.',
	...
	'WRITABLE_CONFIG'		=> 'O teu arquivo de configuración (config.php) ten actualmente permisos de escritura para todo o mundo. Recomendámosche encarecidamente que mudes os permisos a 640 ou, polo menos, a 644 (por exemplo: <a href="http://gl.wikipedia.org/wiki/Chmod" rel="external">chmod</a> 640 config.php).',
));
...
$lang = array_merge($lang, array(
	...
	'INACTIVE_USERS_EXPLAIN_INDEX'	=> 'Esta é unha listaxe dos dez últimos usuarios rexistrados que teñen contas inactivas. Un usuario é inactivo ben porque se configurou a activación de contas e o usuario aínda non a activou, ou ben porque foi desactivado. Unha listaxe completa está dispoñíbel desde o elemento apropiado do menú ou seguindo a ligazón de embaixo onde podes activar, eliminar ou avisar (por email) a estes usuarios.',
...
$lang = array_merge($lang, array(
	...
	'LOG_ACL_ADD_FORUM_LOCAL_F_'		=> '<strong>Autorizacións de foro engadidas ou editadas</strong> from %1$s<br />» %2$s',
	...
	'LOG_ACL_DEL_FORUM_LOCAL_F_'		=> '<strong>Autorizacións para foros de usuario/grupo revogadas</strong> desde %1$s<br />» %2$s',
	...
	'LOG_CONFIG_SEARCH'			=> '<strong>Opcións de procura modificadas</strong>',
	...
	'LOG_CONFIG_VISUAL'			=> '<strong>Opcións anti-spambot modificadas</strong>',
	...
	'LOG_USER_BAN_USER'		=> '<strong>Usuario excluído (banned) desde a xestión de usuario</strong> polo motivo "<em>%1$s</em>"<br />» %2$s',
	'LOG_USER_BAN_IP'		=> '<strong>IP suspendida (banned) desde a xestión de usuario</strong> polo motivo "<em>%1$s</em>"<br />» %2$s',
	'LOG_USER_BAN_EMAIL'	=> '<strong>Email excluído (banned) desde a xestión de usuario</strong> polo motivo "<em>%1$s</em>"<br />» %2$s',
