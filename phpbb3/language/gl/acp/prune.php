...
$lang = array_merge($lang, array(
	...
	'SELECT_USERS_EXPLAIN'		=> 'Introduce nomes de usuario específicos, serán utilizados de forma preferente segundo os criterios anteriores. Non é posíbel purgar os fundadores.',
...
// Forum Pruning
$lang = array_merge($lang, array(
	'ACP_PRUNE_FORUMS_EXPLAIN'	=> 'Isto eliminará calquera tema non visualizado ou ao que non se enviou ningunha mensaxe dentro do número de días escollido. Se non introduces un número todos os temas serán eliminados. Por omisión, non se eliminarán temas nos cales a votación estea aínda activa nin tampouco notas nin anuncios.',
	...
	'PRUNE_FORUM_CONFIRM'			=> 'Estas certo de querer purgar os foros seleccionados coa configuración especificada? Unha vez eliminados, non hai xeito posíbel de recuperar os temas e mensaxes purgadas.',
