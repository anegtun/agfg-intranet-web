...
$lang = array_merge($lang, array(
	'ACP_ATTACHMENT_SETTINGS_EXPLAIN'	=> 'Aquí podes configurar os axustes principais para os adxuntos e as categorías especiáis asociadas.',
	...
	'CHECK_CONTENT_EXPLAIN'		=> 'Algúns navegadores poden ser enganados para que asuman un tipo mime que non se corresponde co arquivo subido. Esta opción asegura que se rexeiten este tipo de subidas.',
	...
	'EXCLUDE_FROM_DISALLOWED_IP'	=> 'Excluír IP dos hosts/IPs prohibidos',
	...
	'FILES_STATS_WRONG'		=> 'As estatísticas de ficheiros semellan ser incorrectas e precisan ser sincronizadas. Os valores actuáis son: número de adxuntos = %1$d, tamaño total dos adxuntos = %2$s.<br />Preme %3$saquí%4$s para resincronizar as estatísticas.',

	'GO_TO_EXTENSIONS'		=> 'Ir á pantalla de xestión de extensións',
	'GROUP_NAME'			=> 'Nome do grupo',

	'IMAGE_LINK_SIZE'			=> 'Dimensións da imaxe ligada',
	'IMAGE_LINK_SIZE_EXPLAIN'	=> 'Amosar imaxes adxuntas coma ligazóns se a imaxe é maior que isto. Pono a 0x0 píxeles para desactivar esta opción.',
	...
	'NO_WRITE_UPLOAD'			=> 'Non se pode escribir no directorio de subida especificado. Múdalle os permisos para que o servidor poida escribir nel.',

	'ONLY_ALLOWED_IN_PM'	=> 'Só permitido en mensaxes privadas',
	'ORDER_ALLOW_DENY'		=> 'Permitir',
	'ORDER_DENY_ALLOW'		=> 'Denegar',

	'REMOVE_ALLOWED_IPS'			=> 'Eliminar ou retirar exclusión de IPs/hosts <em>permitidos</em>',
	'REMOVE_DISALLOWED_IPS'			=> 'Eliminar ou retirar exclusión de IPs/hosts <em>prohibidos</em>',
	'RESYNC_FILES_STATS_CONFIRM'	=> 'Estás seguro de querer sincronizar as estatísticas dos adxuntos?',

	'SECURE_ALLOW_DENY'				=> 'Lista de permitidos/denegados',
	'SECURE_ALLOW_DENY_EXPLAIN'		=> 'Mudar o comportamento por defecto cando se habilita a descarga segura. Se se configura a "Permitir" funcionará coma unha <strong>lista branca (whitelist)</strong> e se se configura a "Denegar" funcionará coma unha <strong>lista negra (blacklist)</strong>.',
	...
	'SECURE_DOWNLOAD_NOTICE'		=> 'As descargas seguras están desactivadas. Os axustes de embaixo só se aplicarán cando se activen as descargas seguras.',
	'SECURE_DOWNLOAD_UPDATE_SUCCESS'=> 'A lista de enderezos IP foi actualizada correctamente.',
	'SECURE_EMPTY_REFERRER'			=> 'Permitir cabeceira "Referrer" baleira',
	...
	'UPLOAD_DIR_EXPLAIN'			=> 'Ruta ao espazo de almacenamento dos adxuntos. Ten en conta que se o mudas unha vez existan arquivos subidos, deberás movelos a man.',
