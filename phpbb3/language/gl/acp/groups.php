...
$lang = array_merge($lang, array(
	...
	'ADD_USERS_EXPLAIN'				=> 'Aquí podes engadir novos usuarios ao grupo. Podes escoller se o grupo se converte en predeterminado para os usuarios escollidos. Adicionalmente podes definilos como administradores do grupo. Introduce cada nome de usuario nunha liña distinta.',
	...
	'GROUP_CONFIRM_ADD_USERS'		=> array(
		1	=> 'Estás certo de querer engadir o usuario %2$s ao grupo?',
		2	=> 'Estás certo de querer engadir os usuarios %2$s ao grupo?',
	),
	...
	'GROUP_EDIT_EXPLAIN'			=> 'Aquí podes editar un grupo existente. Podes trocar o seu nome, descrición e tipo (aberto, pechado etc). Podes configurar tamén algunhas opcións xerais do grupo como a cor, rango etc. Os trocos feitos aquí anulan a configuración actual dos usuarios. Repara en que os membros do grupo poden facer caso omiso da configuración do avatar do grupo agás que estabelezas permisos de usuario axeitados.',
	...
	'GROUP_LIST_EXPLAIN'			=> 'Esta é unha lista completa de todos os membros actualmente pertencentes a este grupo. Podes eliminar membros (agás en certos grupos especiais) ou engadir máis.',
	...
	'GROUP_SKIP_AUTH'				=> 'Excluír o xefe do grupo dos permisos',
	...
	'TEAMPAGE_FORUMS_EXPLAIN'	=> 'Se se activa, amosarase unha liña con todos os foros nos que o moderador teña permisos. Pode supor unha carga para a base de datos en foros grandes.',
	...
	'USER_DEF_GROUPS_EXPLAIN'		=> 'Estes son grupos creados por ti ou por outro administrador do taboleiro. Podes xestionar os participantes así como editar as propiedades do grupo ou incluso eliminar o grupo. Premendo Predeterminado podes configurar o grupo relevante como predeterminado para todos os seus membros.',
