...
$lang = array_merge($lang, array(
	...
	'CUSTOM_FIELDS_NOT_TRANSLATED'	=> 'Cando menos un campo de perfil personalizado non foi traducido aínda. Introduce a información requirida premendo na ligazón &quot;Translate&quot; ',
	...
	'EDIT_DROPDOWN_LANG_EXPLAIN'	=> 'Ten en conta que podes cambiar as túas opcións de texto e tamén engadir novas opcións ao final. Non é aconsellábel engadir novas opcións no medio das existentes, porque podería ter como resultado asignar opcións erróneas aos teus usuarios. Isto pode tamén suceder se eliminas opcións que están no medio. Eliminando opcións  desde o final resultará en que os usuarios que teñan este elemento asignado agora volverán ao estado predeterminado.',
	'EMPTY_FIELD_IDENT'				=> 'Nome de campo baleiro',
	'EMPTY_USER_FIELD_NAME'			=> 'Introduce un nome ou título para o campo',
	'ENTRIES'						=> 'Entradas',
	...
	'INVALID_FIELD_IDENT_LEN'	=> 'O campo de identificación só pode conter ata 17 caracteres',
	...
	'NO_VALUE_OPTION_EXPLAIN'	=> 'Valor para non-entrada. Se este campo é requirido, o usuario terá un erro se escolle a opción seleccionada aquí',
	...
	'SHOW_NOVALUE_FIELD'			=> 'Mostrar o campo se non se escolleu ningún valor',
	'SHOW_NOVALUE_FIELD_EXPLAIN'	=> 'Determina se o campo do perfil debe mostrarse cando non se escolleu ningún valor para os campos opcionais, ou se aínda non se escolleu ningún valor para os campos obrigatorios.',
